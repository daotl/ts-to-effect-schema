  ...
  describe('with circular references', () => {
    ...
    it('should generate the effect schemas', () => {
      expect(
        ...
        export const villainSchema: S.Schema<ReadonlyDeep<Villain>> = S.lazy(() => S.struct({
            name: S.string,
            powers: S.array(S.string),
            friends: S.array(villainSchema)
        }));

        export const evilPlanSchema: S.Schema<ReadonlyDeep<EvilPlan>> = S.lazy(() => S.struct({
            owner: villainSchema,
            description: S.string,
            details: evilPlanDetailsSchema
        }));

        export const evilPlanDetailsSchema: S.Schema<ReadonlyDeep<EvilPlanDetails>> = S.lazy(() => S.struct({
