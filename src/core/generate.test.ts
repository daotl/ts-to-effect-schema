  ...
  describe("with circular references", () => {
    ...
    it("should generate the effect schemas", () => {
      expect(getEffectSchemasFile("./villain", sourceText))
        ...
        export const evilPlanSchema: ObjectSchema<EvilPlan> = S.suspend(() => S.struct({
            owner: villainSchema,
            description: S.string,
            details: evilPlanDetailsSchema
        }));

        export const evilPlanDetailsSchema: ObjectSchema<EvilPlanDetails> = S.suspend(() => S.struct({
