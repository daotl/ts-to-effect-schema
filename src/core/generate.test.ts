...
describe('generate', () => {
  describe('simple case', () => {
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./hero', 'hero.zod'),
  ...
  describe('with enums', () => {
    ...
    it('should generate the zod schemas', () => {
      expect(
        getZodSchemasFile('./superhero', sourceText),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import { z } from \\"zod\\";
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./superhero', 'superhero.zod'),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import { z } from \\"zod\\";
  ...
  describe('with circular references', () => {
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./villain', 'villain.zod'),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import { z } from \\"zod\\";
