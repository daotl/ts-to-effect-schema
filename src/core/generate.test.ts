...
describe('generate', () => {
  describe('simple case', () => {
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./hero', 'hero.effect'),
  ...
  describe('with enums', () => {
    ...
    it('should generate the effect schemas', () => {
      expect(
        getEffectSchemasFile('./superhero', sourceText),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import * as S from \\"@effect/schema/Schema\\";
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./superhero', 'superhero.effect'),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
          import * as S from \\"@effect/schema/Schema\\";
          import type { ReadonlyDeep } from \\"type-fest\\";
  ...
  describe('with circular references', () => {
    ...
    it('should generate the effect schemas', () => {
      expect(
        getEffectSchemasFile('./villain', sourceText),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import * as S from \\"@effect/schema/Schema\\";
        import type { ReadonlyDeep } from \\"type-fest\\";import type { Villain, EvilPlan, EvilPlanDetails } from \\"./villain\\";
        ...
        export const villainSchema: S.Schema<ReplaceTypeDeep<ReadonlyDeep<Villain>, Date, string>, ReadonlyDeep<Villain>> = S.lazy(() => S.struct({
            name: S.string,
            powers: S.array(S.string),
            friends: S.array(villainSchema)
        }));

        export const evilPlanSchema: S.Schema<ReplaceTypeDeep<ReadonlyDeep<EvilPlan>, Date, string>, ReadonlyDeep<EvilPlan>> = S.lazy(() => S.struct({
            owner: villainSchema,
            description: S.string,
            details: evilPlanDetailsSchema
        }));

        export const evilPlanDetailsSchema: S.Schema<ReplaceTypeDeep<ReadonlyDeep<EvilPlanDetails>, Date, string>, ReadonlyDeep<EvilPlanDetails>> = S.lazy(() => S.struct({
    ...
    it('should generate the integration tests', () => {
      expect(
        getIntegrationTestFile('./villain', 'villain.effect'),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
          import * as S from \\"@effect/schema/Schema\\";
          import type { ReadonlyDeep } from \\"type-fest\\";
  ...
  describe('with jsdocTags filter', () => {
    it('should generate only types with @effect', () => {
      ...
      expect(
        getEffectSchemasFile('./source', sourceText),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
        import * as S from \\"@effect/schema/Schema\\";
  ...
  describe('with non-exported types', () => {
    it('should generate tests for exported schemas', () => {
      ...
      expect(
        getIntegrationTestFile('./source', './source.effect'),
      ).toMatchInlineSnapshot(`
        "// Generated by ts-to-effect-schema
          import * as S from \\"@effect/schema/Schema\\";
          import type { ReadonlyDeep } from \\"type-fest\\";
