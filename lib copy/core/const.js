...
exports.primitivePropertyList = exports.standardBuiltInObjectVarNames = exports.standardBuiltInObjects = void 0;
// Reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects
exports.standardBuiltInObjects = [
...
exports.standardBuiltInObjectVarNames = exports.standardBuiltInObjects.map((n) => `${n[0].toLocaleLowerCase()}${n.substring(1)}Schema`);
exports.primitivePropertyList = [
    // primitive values
    'string',
    'number',
    'bigint',
