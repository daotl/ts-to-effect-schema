 ...
 */
function validateGeneratedTypes({ sourceTypes, effectSchemas, integrationTests, skipParseJSDoc, }) {
    ...
    const env = (0, vfs_1.createVirtualTypeScriptEnvironment)(system, [sourceTypes, effectSchemas, integrationTests].map(getPath), typescript_1.default, compilerOptions);
    // Get the diagnostic
    const errors = [];
