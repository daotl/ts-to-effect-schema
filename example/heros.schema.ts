...
export const villainSchema: S.Schema<ReadonlyDeep<Villain>> = S.lazy(() =>
  S.struct({
    name: S.string,
    powers: S.array(enemyPowerSchema),
...
export const evilPlanSchema: S.Schema<ReadonlyDeep<EvilPlan>> = S.lazy(() =>
  S.struct({
    owner: villainSchema,
...
export const evilPlanDetailsSchema: S.Schema<ReadonlyDeep<EvilPlanDetails>> =
  S.lazy(() =>
    S.struct({
